...
document.querySelector("#cards").innerHTML = 
    ...
    createCard("27/11","domingo",createGame("japao", "07:00", "costarica") +
    ...
    createCard("30/11","quarta",createGame("tunisia", "12:00", "franca") +
    createGame("australia", "12:00", "dinamarca") +
    createGame("polonia", "16:00", "argentina") +
    createGame("arabia", "16:00", "mexico")
    ) +
    createCard("01/12","quinta",createGame("croacia", "12:00", "belgica") +
